...
const projects = [
  {
    ...
    desc: "ग्रामीण और शहरी घरों तक पाइपलाइन से स्वच्छ पेयजल उपलब्ध कराने का लक्ष्य, जिससे महिलाओं को पानी भरने की समस्या से राहत मिली।",
  },
  {
    ...
    desc: "‘सात निश्चय’ कार्यक्रम के तहत हर घर नल का जल सुनिश्चित कर जीवन स्तर और स्वास्थ्य में सुधार पर फोकस।",
  },
  {
    ...
    desc: "नए हाईवे और मुख्य सड़कों के निर्माण से राज्यों के बीच तेज़ और सुरक्षित कनेक्टिविटी।",
  },
  {
    ...
    desc: "गांवों को शहरों और बाज़ारों से जोड़ने के लिए पक्की सड़कों का निर्माण, जिससे आर्थिक गतिविधि बढ़ती है।",
  },
  {
    ...
    desc: "शहरी क्षेत्रों में मौजूदा सड़कों की चौड़ाई बढ़ाना, रीसर्फेसिंग और ड्रेनेज सुधार जैसे कार्य।",
  },
  {
    ...
    desc: "औद्योगिक क्षेत्रों तक हैवी व्हीकल मूवमेंट के लिए मज़बूत और टिकाऊ सड़क अवसंरचना तैयार करना।",
  },
  {
    img: "https://images.livemint.com/rf/Image-621x414/LiveMint/Period1/2015/04/27/Photos/rc-kw9H--621x414@LiveMint.jpg",
    title: "Maintenance & Repair",
    desc: "सड़कों पर गड्ढों की मरम्मत, रीसर्फेसिंग और मार्किंग रीपेंटिंग जैसे नियमित रखरखाव कार्य।",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <div
              key={index}
              className="relative group overflow-hidden rounded-xl h-[300px] shadow-lg"
            >
              {/* Image */}
              <img
                src={project.img}
              ...
              >
                <div className="p-5 text-white">
                  ...
                  <p className="text-xs md:text-sm mt-1 opacity-90 drop-shadow">
                    {project.desc}
                  </p>
                </div>
              </div>
